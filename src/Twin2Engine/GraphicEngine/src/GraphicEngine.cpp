...
#pragma endregion
	...
	Shader* shader = ShaderManager::CreateShaderProgram("origin/Basic", "shaders/normalVert.vert", "shaders/LightingShader.frag");
...
void Twin2Engine::GraphicEngine::GraphicEngine::Render()
{
	glBindTexture(GL_TEXTURE_2D, _depthMap);
	glBindFramebuffer(GL_FRAMEBUFFER, _depthMapFBO);
...
GLuint Twin2Engine::GraphicEngine::GraphicEngine::GetDepthMap() const {
	return _depthMap;
}